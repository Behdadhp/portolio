...
#
# Driven by env vars. Defaults to local Postgres so dev and prod share an
# engine. To run against SQLite (e.g. ephemeral CI sandbox) set
# `DB_ENGINE=sqlite`.
...
# Cache (used to store real-time prices from Finnhub)
CACHES = {
    "default": {
...
STOCK_QUOTE_INTERVAL = int(
    os.getenv("STOCK_QUOTE_INTERVAL", "15")
)  # seconds between REST polls for stock prices
...
DEFAULT_FROM_EMAIL = os.getenv(
    "DEFAULT_FROM_EMAIL", "Portfolio Alerts <noreply@portfolio.local>"
)
